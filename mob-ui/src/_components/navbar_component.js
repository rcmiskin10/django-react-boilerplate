      ...
      <div className={classes.root}>
        <AppBar position="fixed" style={{ background: 'white'}}>
          <Toolbar>
            ...
            <Typography className={classes.flex} variant="title" color="#484848" >
              Mobsteer
            </Typography>
            {!this.props.isAuthenticated && this.props.width !== "xs" && <Button onClick={() => this.handleRedirect("business")} color="#484848">Create a Deal</Button>}
            {!this.props.isAuthenticated && this.props.width !== "xs" && <Button onClick={() => this.handleRedirect("event")} color="#484848">Create an Event</Button>}
            {!this.props.isAuthenticated && this.props.width !== "xs" && <Button onClick={() => this.handleRedirect("participant")} color="#484848">Participant Signup</Button>}
            {!this.props.isAuthenticated && this.props.width !== "xs" && <Button onClick={() => this.handleRedirect("login")} color="#484848">Login</Button>}
